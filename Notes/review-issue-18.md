...
- Summary period key contract: “Sorting must use an internal chronological key, not rendered labels. Since date ranges can span years, Month/Quarter do not aggregate across years, but show their corresponding year.”
