...
- [src/lib/email-utils.ts](./src/lib/email-utils.md) — Email normalization helper (`normalizeEmail`) used before auth lookups and comparisons.
...
- [src/lib/logger.ts](./src/lib/logger.md) — Structured JSON logging with sensitive-data redaction.
