 ...
 */
testSmtpRouter.post('/set-smtp-config', secureHeaders(STANDARD_SECURE_HEADERS), async (c) => {
  try {
 ...
 */
testSmtpRouter.post('/reset-smtp-config', secureHeaders(STANDARD_SECURE_HEADERS), async (c) => {
  try {
